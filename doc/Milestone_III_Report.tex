...
When looking at the plots of the upper two panels in Figure \ref{fig:fig1} we see the monopole and dipole moments of the radiation perturbations. In fact early on, when baryons and photons where coupled, these two components formed a single fluid. When looking at, for instance, the monopole moment of the upper right panel, we see also the different behaviour of the perturbations on different scales. The largest scales, stretching outside the Hubble sphere $r= 1/H$, remain basically unaffected for the entire history of the universe. That is because the perturbations are larger than the causally connected region on which gravity and pressure could act, resulting in no perturbation growth. 

On the very small scales, on which gravity and pressure can act as we are inside a causally connected region of spacetime, we see an oscillatory behaviour at early times. These are the so called acoustic oscillations of the matter-radiation plasma. The oscillations basically show the interplay between gravity, which contracts the perturbations rarifying them, and the pressure forces by the enormous radiation pressure expanding the perturbations. Initially a perturbation grows, i.e. the density given by the monopole $\Theta_0$ grows when falling into a gravitational well. When the plasma falls in to the potential well, the pressure increases, gradually slowing down the growth in $\Theta_0$, eventually able to counteract the pull of gravity. This expansion leads to the perturbation shrinking again. 

The oscillations on these small scales keep on going until the epoch of recombination and can ve interpreted as sound waves in the plasma. At that time the radiation and baryon decouple and the photons can free stream out of any potential wells. Thus the oscillations effectively stop as the photons travel freely, not being bound in the dense plasma. We see exactly this happening in the plots, where the oscillating perturbations decay rapidly as they cross the epoch of decoupling. Further more, it is these free streaming photons that give rise to the CMB we see today. Hence the anisotropies seen in the CMB are the frozen in picture of the photons at their last oscillation before decoupling. In fact the perturbations that perform one half expansion, i.e. collapse to the point right before subsequent expansion, within the time of recombination $x_*$ form the first peak of the acoustic oscillation pattern in the later-to-be computed CMB angular power spectrum. Similarly the other peaks of the CMB power spectrum are perturbations having performed multiples or halves of oscillations at the time of decoupling, and the troughs of the power spectrum are formed by the perturbations crossing the zero line in their oscillation at $x_*$.

Notice also that smaller scale perturbations perform ore oscillations than the somewhat large ones (the yellow and black curves in Figure \ref{fig:fig1}). This is due to two effects, the first of which is the basic fact that smaller scales enter the horizon earlier and can hence start growing under gravity earlier. The second reason is that pressure (waves) that travel with the sound speed of the medium $c_s$ ($\sim c$ early on) will take longer to establish pressure against gravity in a larger scale perturbation. This might be the reason for why the oscillation peaks of $\Theta_0$ for $k = 0.3/\mathrm{{Mpc}}$ are slightly narrower than the once of $k = 0.0527/\mathrm{Mpc}$, before recombination. However, there could also be other more complicated processes involved in these effects.

Next, we see that the oscillations are not equal in hight. This is a consequence of the fluid in which the oscillations happen, is a composite of photons and baryons. The latter of which "prefer" to clump more and thus more easily rarify than it expands.  

The behaviour of the dipole $\Theta_1$ seems to correspond well to the behaviour of the monopole $\Theta_0$. We also here see the large superhorizon scales, effectively not affecting the velocity perturbations at all. While the smaller subhorizon scales perform oscillations. However, we see a phase shift between the oscillations of the dipole compared to the monopole. Since the monopole growing corresponds to a perturbation falling into a potential well, we will have a collapsing behaviour with a negative radial velocity. Hence the dipole will have a trough initially where the monopole has a peak for the oscillating perturbations. The dipole, nevertheless, also decays after recombination as the photons are free streaming.
